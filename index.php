...
<html lang="en">
  ...
  <body>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card mb-3">
            <div class="d-flex gap-3">
              <img
                src="/termproject/pics/penguins.jpg"
                alt=""
        ...
        <div class="col-md-4">
          <div class="card mb-3">
            <div class="d-flex gap-3">
              <img
                src="/termproject/pics/puppies.webp"
                alt=""
                class="img-fluid rounded-circle picture-size"
              />
            </div>
    ...
    <script src="/termproject/js/bootstrap.bundle.min.js"></script>
    <script src="/termproject/js/darkmodetoggle.js"></script>
    <script src="/termproject/js/script.js"></script>
